...
namespace SeyfolioWeb
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            });  //tüm isteklere otomatik olarak kimlik doðrulama yapýlmasýný saðlar.
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseStatusCodePagesWithReExecute("/Error/ErrorPage401"); // 401 gibi durum kodlarýný yönlendirmek için kullandýk. olmayan bir route girildiðinde bu kod çalýþacak ve ErrorPage401 sayfasý render edilecek.
